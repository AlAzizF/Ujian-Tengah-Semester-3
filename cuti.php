...
if(isset($_POST['save'])){
$query_input=mysqli_query($koneksi,"insert into cuti(`nik_karyawan`, `nama_karyawan`, `jenis_cuti`, `total_cuti`, `tanggal_cuti`, `sampai_tanggal`, `no_tlpon`, `alasan`)
